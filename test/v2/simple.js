...
const baseCases = [
  ...
  [
    ...
    [null, 0, true, "string"],
    { version: 2, crunched: [[null, 1, true, "string"]] },
  ],
  [
    "multi-primitive repeated array",
    [true, true, true, true],
    { version: 2, crunched: [[true, true, true, true]] },
  ],
  [
    "one-level nested array",
    [[1, 2, 3]],
    { version: 2, crunched: [0, [[3, 5, 7]]] },
  ],
  [
    "two-level nested array",
    [[[1, 2, 3]]],
    { version: 2, crunched: [0, 0, [[[3, 5, 7]]]] },
  ],
  ...
  [
    ...
    { version: 2, crunched: [{ a: null, b: 1, c: true, d: "string" }] },
  ],
  [
    "multi-item repeated object",
    { a: null, b: null, c: null, d: null },
    { version: 2, crunched: [{ a: null, b: null, c: null, d: null }] },
  ],
  [
    "complex array",
    [{ a: true, b: [1, 2, 3] }, [1, 2, 3]],
    { version: 2, crunched: [[3, 5, 7], 0, [{ a: true, b: 0 }, 0]] },
  ],
  [
    "complex object",
    ...
    {
      version: 2,
      crunched: [[3, 5, 7], 0, { a: true, b: 0, c: { a: true, b: 0 } }],
    },
  ],
  [
    "empty object/array",
    { a: {}, b: [] },
    { version: 2, crunched: [0, 0, { a: {}, b: [] }] },
  ],
  [
    "date",
    { a: new Date("2021-03-31T18:34:09.000Z") },
    { version: 2, crunched: [{ a: new Date("2021-03-31T18:34:09.000Z") }] },
  ],
];
